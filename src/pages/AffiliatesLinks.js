      ...
      >
        ...
        <div className="d-flex flex-wrap justify-content-left">
          <Card className="col-sm-12 col-md-6 col-lg-4 p-2 border-0">
            <Card.Header>
              <Card.Title style={{ color: `${userInputs.h1Color}` }}>
                Pokemon TCG Scarlet & Violet—151 6 Booster Pack Set
              </Card.Title>
              <img
                className="card-img-top projectImage"
                src={pokemon}
                alt="Pokemon TCG Scarlet & Violet—151 Booster Bundle Set"
              />
            </Card.Header>
            ...
            <Card.Body>
              <Card.Text style={{ color: `${userInputs.pColor}` }}>
                ...
                Discover the extraordinary Venusaur ex, Charizard ex, Mew ex &
                Blastoise ex in special cards with captivating illustrations, as
                well as the rest of the original 151 Pokemon from the Kanto
                region. Set includes 6 booster packs.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <div className="text-center">
                <a
                  href="https://amzn.to/45CfEtO"
                  rel="noreferrer"
                  target="_blank"
          ...
          <Card className="col-sm-12 col-md-6 col-lg-4 p-2 border-0">
            <Card.Header>
              <Card.Title style={{ color: `${userInputs.h1Color}` }}>
                Lego Ideas 21349 LEGO Tuxedo Cat
              </Card.Title>
              <img
                className="card-img-top projectImage"
                src={cat}
            ...
            <Card.Body>
              <Card.Text style={{ color: `${userInputs.pColor}` }}>
                ...
                Allergic to real cats? Get your paws on this 1710-piece posable
                LEGO Tuxedo Cat instead! Rotate the cat’s head and adjust the
                ears, paws and tail for different poses, bringing character to
                any desk or home. Currently $116 (32% off, RRP $169.99), click
                the link to grab one for yourself.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <div className="text-center">
                <a
                  href="https://amzn.to/43ZHvmo"
                  rel="noreferrer"
                  target="_blank"
                  aria-label="Opens Lego Ideas 21349 LEGO Tuxedo Cat Amazon product page in a new tab"
                >
                  <FormButton
                    className="form-btn-primary"
                    type="button"
